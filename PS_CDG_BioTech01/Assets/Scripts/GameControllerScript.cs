...
public class GameControllerScript : MonoBehaviour
{
    ...
    // Job Option Links
    // Job Option Links - Biomedical Engineer
    // Job Option Links - Biomedical Engineer - More Information
    public void Job01MoreLink()
    {
        // Biomedical Engineer - More Info
        Application.OpenURL("https://www.bls.gov/ooh/architecture-and-engineering/biomedical-engineers.htm");
    }
    // Job Option Links - Biomedical Engineer - Companies
    public void Job01Comp01Link()
    {
        // Biomedical Engineer - Johnson & Johnson
        Application.OpenURL("https://www.careers.jnj.com/en/");
    }
    public void Job01Comp02Link()
    {
        // Biomedical Engineer - Siemens Healthcare
        Application.OpenURL("https://www.siemens-healthineers.com/careers");
    }
    public void Job01Comp03Link()
    {
        // Biomedical Engineer - Abbott Laboratories
        Application.OpenURL("https://www.abbott.com/careers.html");
    }
    public void Job01Comp04Link()
    {
        // Biomedical Engineer - GE Healthcare
        Application.OpenURL("https://careers.gehealthcare.com/global/en/");
    }
    public void Job01Comp05Link()
    {
        // Biomedical Engineer - Boston Scientific
        Application.OpenURL("https://www.bostonscientific.com/en-US/careers.html");
    }
    // Job Option Links - Biochemist
    // Job Option Links - Biochemist - More Information
    public void Job02MoreLink()
    {
        // Biochemist - More Info
        Application.OpenURL("https://www.bls.gov/ooh/life-physical-and-social-science/biochemists-and-biophysicists.htm");
    }
    // Job Option Links - Biochemist - Companies
    ...
    {
        // Biochemist - Abbott Laboratories
        Application.OpenURL("https://www.abbott.com/careers.html");
    }
    public void Job02Comp03Link()
    {
        // Biochemist - Siemens Healthcare
        Application.OpenURL("https://www.siemens-healthineers.com/careers");
    }
    public void Job02Comp04Link()
    {
        // Biochemist - Bio-Rad Laboratories
        Application.OpenURL("https://careers.bio-rad.com/");
    }
    public void Job02Comp05Link()
    {
        // Biochemist - Genentech
        Application.OpenURL("https://careers.gene.com/us/en/");
    }
    // Job Option Links - Epidemiologist
    // Job Option Links - Epidemiologist - More Information
    public void Job03MoreLink()
    {
        // Epidemiologist - More Info
        Application.OpenURL("https://www.bls.gov/oes/2023/may/oes191041.htm");
    }
    // Job Option Links - Epidemiologist - Companies
    public void Job03Comp01Link()
    {
        // Epidemiologist - CDC
        Application.OpenURL("https://jobs.cdc.gov/");
    }
    public void Job03Comp02Link()
    {
        // Epidemiologist - Genentech
        Application.OpenURL("https://careers.gene.com/us/en/");
    }
    public void Job03Comp03Link()
    {
        // Epidemiologist - Novartis
        Application.OpenURL("https://www.novartis.com/careers");
    }
    public void Job03Comp04Link()
    {
        // Epidemiologist - Medasource
        Application.OpenURL("https://jobs.medasource.com/");
    }
    public void Job03Comp05Link()
    {
        // Epidemiologist - RTI International
        Application.OpenURL("https://www.rti.org/careers");
    }
    // Job Option Links - Medical Technologist
    // Job Option Links - Medical Technologist - More Information
    public void Job04MoreLink()
    {
        // Medical Technologist - More Info
        Application.OpenURL("https://www.vivian.com/allied-health/medical-technologist/florida/salary/");
    }
    // Job Option Links - Medical Technologist - Companies
    public void Job04Comp01Link()
    {
        // Medical Technologist - Johnson & Johnson
        Application.OpenURL("https://www.careers.jnj.com/en/");
    }
    public void Job04Comp02Link()
    {
        // Medical Technologist - Abbott Laboratories
        Application.OpenURL("https://www.abbott.com/careers.html");
    }
    public void Job04Comp03Link()
    {
        // Medical Technologist - Medtronic
        Application.OpenURL("https://www.medtronic.com/en-us/our-company/careers.html");
    }
    public void Job04Comp04Link()
    {
        // Medical Technologist - Siemens Healthcare
        Application.OpenURL("https://www.siemens-healthineers.com/careers");
    }
    public void Job04Comp05Link()
    {
        // Medical Technologist - Danaher
        Application.OpenURL("https://jobs.danaher.com/global/en");
    }
    // Job Option Links - Biostatistician
    // Job Option Links - Biostatistician - More Information
    public void Job05MoreLink()
    {
        // Biostatistician - More Info
        Application.OpenURL("https://www.indeed.com/career-advice/careers/what-does-a-biostatistician-do");
    }
    // Job Option Links - Biostatistician - Companies
    public void Job05Comp01Link()
    {
        // Biostatistician - Parexel
        Application.OpenURL("https://www.parexel.com/https://www.parexel.com/");
    }
    public void Job05Comp02Link()
    {
        // Biostatistician - Sanofi
        Application.OpenURL("https://jobs.sanofi.com/en");
    }
    public void Job05Comp03Link()
    {
        // Biostatistician - IQVIA
        Application.OpenURL("https://labs.iqvia.com/");
    }
    public void Job05Comp04Link()
    {
        // Biostatistician - Cancer Research and Biostatistics
        Application.OpenURL("https://www.crab.org/careers/");
    }
